	...
	<section id="content">
		<form action="#">
			...
			<div>
				...
				<input type="text" placeholder="Email" name="spec" required/>
				<input type="text" placeholder="Contact No." name="avai" required/>
				<input type="text" placeholder="Age" name="pass" required/>
                <input type="number" placeholder="Captcha" name="pass" required/>
			</div>
			<div>
			<br><br>
			</div>
